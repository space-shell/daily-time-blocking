# US-001 — Plan My Day with Time Blocks

**As a** knowledge worker,
**I want to** place labelled time blocks on a daily timeline,
**So that** I have a clear visual plan for how my day is structured.
...
- [ ] Each block shows its label and time range (e.g. "9:00am – 10:00am")
- [ ] Blocks can be moved after placement (drag on desktop)
- [ ] Blocks can be deleted via a × button
